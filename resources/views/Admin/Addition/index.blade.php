...
@section('page_title') الاضافات @endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" >الاضافات</h3>
                    <div class="mr-auto pageheader-btn">
                        @if(in_array(71,admin()->user()->permission_ids))
...
@push('admin_js')
    ...
    @include('layouts.admin.inc.ajax',['url'=>'additions'])
