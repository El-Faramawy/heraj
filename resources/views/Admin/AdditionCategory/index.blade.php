...
@section('page_title') اقسام الاضافات @endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title" >اقسام الاضافات</h3>
                    <div class="mr-auto pageheader-btn">
                        @if(in_array(67,admin()->user()->permission_ids))
                    ...
                    <div class="table-responsive">
                        <table id="exportexample" class="table table-striped table-responsive-lg  card-table table-vcenter text-nowrap mb-0 table-primary align-items-center mb-0">
                            ...
                            <tr>
                                ...
                                <th class="text-white">عدد الاختيارات</th>
...
@push('admin_js')
    <script>
        var  columns =[
            ...
            {data: 'choise', name: 'choise'},
            {data: 'action', name: 'action', orderable: false, searchable: false},
        ];
        //======================== addBtn =============================

    </script>
    @include('layouts.admin.inc.ajax',['url'=>'addition_categories'])
@endpush
