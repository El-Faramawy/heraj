...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('cities.update',$city->id)}}">
    ...
    <div class="row mt-0">
        ...
        <div class="d-flex flex-column mb-2 fv-row col-sm-12 mt-0">
            ...
            <!--end::Label-->
            <input type="text" class="form-control form-control-solid" placeholder="الإسم ( بالعربية )" name="name_ar" value="{{$city->name_ar}}"/>
        </div>
        <!--end::Input group-->
        <!--begin::Input group-->
        <div class="d-flex flex-column mb-2 fv-row col-sm-12 mt-0">
            ...
            <!--end::Label-->
            <input type="text" class="form-control form-control-solid" placeholder="الإسم ( بالانجليزية )" name="name_en" value="{{$city->name_en}}"/>
        </div>
        <!--begin::Input group-->
    </div>
