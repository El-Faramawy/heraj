...
@section('page_title') الكوبون @endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">الكوبون</h3>
                    <div class="mr-auto pageheader-btn">
                        @if(in_array(79,admin()->user()->permission_ids))
                    ...
                    <div class="table-responsive">
                        <table id="exportexample" class="table table-striped table-responsive-lg  card-table table-vcenter text-nowrap mb-0 table-primary align-items-center mb-0">
                            ...
                            <tr>
                                ...
                                <th class="text-white">كوبون على</th>
                                <th class="text-white">النوع</th>
                                <th class="text-white">القيمة</th>
                                <th class="text-white">النسبة</th>
                                <th class="text-white">اقل قيمة</th>
                                <th class="text-white">اعلى قيمة</th>
...
@push('admin_js')
    ...
    @include('layouts.admin.inc.ajax',['url'=>'coupons'])
